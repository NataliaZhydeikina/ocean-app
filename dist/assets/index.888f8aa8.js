 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ew=Xe.exports,Tw=Symbol.for("react.element"),Cw=Symbol.for("react.fragment"),bw=Object.prototype.hasOwnProperty,Aw=Ew.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Lw={key:!0,ref:!0,__self:!0,__source:!0};function Vg(n,e,t){var i,r={},s=null,o=null;t!==void 0&&(s=""+t),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)bw.call(e,i)&&!Lw.hasOwnProperty(i)&&(r[i]=e[i]);if(n&&n.defaultProps)for(i in e=n.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:Tw,type:n,key:s,ref:o,props:r,_owner:Aw.current}}gl.Fragment=Cw;gl.jsx=Vg;gl.jsxs=Vg;(function(n){n.exports=gl})(ml);const Gg=ml.exports.Fragment,je=ml.exports.jsx,Ni=ml.exports.jsxs,Hg=Xe.exports.createContext({});function Pw({layout:n,canvas:e}){var o;const t=new ww,i=Xe.exports.useRef(0),[r,s]=Xe.exports.useState({});return Xe.exports.useEffect(()=>(i.current=t.init(),s({position:"fixed",width:"100%",height:"100%",top:0,left:0,overflow:"hidden"}),()=>t.destroy(i.current)),[]),Xe.exports.useEffect(()=>{t.setSize()},[(o=t.scrollable.current)==null?void 0:o.scrollHeight]),Ni(Hg.Provider,{value:t,children:[je("main",{style:r,children:je("div",{"data-scroll":!0,ref:t.getRef(),children:n})}),e]})}function Dw(n){const e=new Ug,t=Xe.exports.useContext(Hg),i=()=>{n.setScroll(t.scrollToRender,t.speedTarget);const r=e.getElapsedTime();n.render(r)};return Xe.exports.useEffect(()=>{t.setCallback(i)},[]),n}function Rw(n=innerWidth,e=innerHeight){return Dw(Mw(new Sw({width:n,height:e})))}const Wg=Xe.exports.createContext({});function Iw({children:n}){const[e,t]=Xe.exports.useState(Rw());return Xe.exports.useEffect(()=>{t(e.init())},[]),je(Wg.Provider,{value:e,children:je("canvas",{ref:e.getRef(),children:n})})}var Nw=`uniform float uTime;
uniform vec2 hover;
